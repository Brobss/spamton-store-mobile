  ...
  return (
    <ScrollView style={styles.container}>
      <ScrollView>
        ...
        <TouchableOpacity style={styles.option} onPress={() => {}}>
          <MaterialCommunityIcons name="credit-card" size={35} color="#fff" />
          <ScrollView style={styles.info}>
        ...
        <TouchableOpacity style={styles.option} onPress={() => {}}>
          <MaterialCommunityIcons name="heart-outline" size={35} color="#fff" />
          <ScrollView style={styles.info}>
      ...
      <View style={styles.menuAdicional}>
        <TouchableOpacity style={styles.opcoesAdicionais}>
          <View style={styles.wrapper}>
            <MaterialCommunityIcons name="lifebuoy" size={25} color="#f4ff75" />
        ...
        >
          <View style={styles.wrapper}>
            <MaterialIcons name="settings" size={25} color="#f4ff75" />
        ...
        <TouchableOpacity style={styles.opcoesAdicionais}>
          <View style={styles.wrapper}>
            <MaterialIcons name="security" size={25} color="#f4ff75" />
        ...
        <TouchableOpacity style={styles.opcoesAdicionais}>
          <View style={styles.wrapper}>
            <MaterialCommunityIcons name="rocket" size={25} color="#f4ff75" />
